...
#from tensorflow.python.keras.optimizers.schedules import PiecewiseConstantDecay
...
class Trainer:
    ...
    def train_step(self, lr, hr,ref=None):
        with tf.GradientTape() as tape:
            ...
            #sr = resize(sr, (hr.shape[0], hr.shape[1] // 2, hr.shape[2] // 2, hr.shape[3]), anti_aliasing=True)
            #print(sr.shape)
